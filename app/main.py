...
MOODS = {
    "грусть-тоска": "Говори тише, с паузами, как будто всё тяжело. Иногда добавляй 'эх…' в конце.",
    ...
    "меланхоличный": "Используй метафоры, образы, будто осень в душе.",
    "подкалывающий задорный": "Тролль без злобы, энергично, весело.",
    "влюбленный": "Будь мягче, романтичнее, намекай на чувства, вставляй внезапные признания."
}
